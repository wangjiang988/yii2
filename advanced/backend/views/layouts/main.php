            ...
            <ul class="nav pull-right">
                ...
                <li class="dropdown user">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="username" user-id="<?=Yii::$app->user->identity->id?>">
...
<!--                        <li>  <a href="--><?//=Url::to(['site/logout']); ?><!--" data-method="post" tabindex="-1">-->
<!--                                <i class="icon-signout"></i> 退出</a>-->
<!--                        </li>-->
                        <li><a href="<?=Url::to(['/site/logout']); ?>" data-method="post"><i class="icon-signout"></i>
                            退出
                            </a></li>
